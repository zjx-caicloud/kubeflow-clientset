...
var tfjobsResource = schema.GroupVersionResource{Group: "kubeflow.k8s.io", Version: "v1alpha1", Resource: "tfjobs"}

var tfjobsKind = schema.GroupVersionKind{Group: "kubeflow.k8s.io", Version: "v1alpha1", Kind: "TFJob"}
